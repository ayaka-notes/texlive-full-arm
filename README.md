...
For example:
```
ALL_TEX_LIVE_DOCKER_IMAGES=ghcr.io/ayaka-notes/texlive-full-arm:2026.1, ghcr.io/ayaka-notes/texlive-full-arm:2025.1
ALL_TEX_LIVE_DOCKER_IMAGE_NAMES=Texlive 2026, Texlive 2025
TEX_LIVE_DOCKER_IMAGE=ghcr.io/ayaka-notes/texlive-full-arm:2026.1
```
...
- `ghcr.io/ayaka-notes/texlive-full-arm:2026.1` (Also `latest` tag)
- `ghcr.io/ayaka-notes/texlive-full-arm:2025.1`
